...
-- Crear ScreenGui con insets seguros
...
-- ── Escala: base para 360x640 (móvil típico) ──
...
local function updateScale()
	...
	-- Usamos el menor para mantener proporción, sin dejar que se vea demasiado pequeño o grande
...
toggleBtn.Size = UDim2.new(0, 32, 0, 32)          -- tamaño táctil cómodo
...
mainFrame.Size = UDim2.new(0, 170, 0, 280)        -- base para móvil, se escalará
mainFrame.Position = UDim2.new(1, -6, 0, 44)       -- debajo del botón toggle
mainFrame.AnchorPoint = Vector2.new(1, 0)
mainFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
mainFrame.BackgroundTransparency = 0.1
mainFrame.BorderSizePixel = 0
mainFrame.Visible = true   -- comienza visible
mainFrame.ZIndex = 5
...
local function createPlayerEntry(player, layoutOrder)
	...
	entry.Size = UDim2.new(1, -4, 0, 38)          -- más altura para tocar
